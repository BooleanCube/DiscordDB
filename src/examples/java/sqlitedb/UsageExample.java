...
public class UsageExample {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        SQLDatabase.dropTable("profiles");

        ProfileDatabase.setupTables();

        ProfileDatabase.addProfile("1", "'hey'", 1111, "'nah'");
        ...
        System.out.println("New username of BouillonCube: " + ProfileDatabase.getUsername("659174165424635905"));
